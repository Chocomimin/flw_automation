...
async function fillMobileNumber(driver, mobileNumber) {
    try {
        await driver.$('android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().textContains("Mobile No"))');
    } catch (e) {}

    const f = await driver.$('//android.widget.EditText[contains(@hint, "Mobile No") or contains(@text, "Mobile No")] | //android.widget.TextView[contains(@text, "Mobile No")]/parent::*//android.widget.EditText');
    await f.waitForDisplayed({ timeout: 10000 });
    await f.click();
    await f.clearValue();
    ...
    console.log('✅ Mobile Number entered/edited successfully');
}

async function fillHouseNo(driver, houseNo) {
    try {
        await driver.$('android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().textContains("House No"))');
    } catch (e) {}

    const f = await driver.$('//android.widget.EditText[contains(@hint, "House No") or contains(@text, "House No")] | //android.widget.TextView[contains(@text, "House No")]/parent::*//android.widget.EditText');
    await f.waitForDisplayed({ timeout: 10000 });
    await f.click();
    await f.clearValue();
    ...
    console.log('✅ House Number entered/edited successfully');
}

async function fillWardNo(driver, wardNo) {
    try {
        await driver.$('android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().textContains("Ward No"))');
    } catch (e) {}

    const f = await driver.$('//android.widget.EditText[contains(@hint, "Ward No") or contains(@text, "Ward No")] | //android.widget.TextView[contains(@text, "Ward No")]/parent::*//android.widget.EditText');
    await f.waitForDisplayed({ timeout: 10000 });
    await f.click();
    await f.clearValue();
    ...
    console.log('✅ Ward Number entered/edited successfully');
}

async function fillWardName(driver, wardName) {
    try {
        await driver.$('android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().textContains("Ward Name"))');
    } catch (e) {}

    const f = await driver.$('//android.widget.EditText[contains(@hint, "Ward Name") or contains(@text, "Ward Name")] | //android.widget.TextView[contains(@text, "Ward Name")]/parent::*//android.widget.EditText');
    await f.waitForDisplayed({ timeout: 10000 });
    await f.click();
    await f.clearValue();
    ...
    console.log('✅ Ward Name entered/edited successfully');
}
...
async function fillMohallaName(driver, mohallaName) {
    ...
    const f = await driver.$('//android.widget.EditText[contains(@hint, "Mohalla Name") or contains(@text, "Mohalla Name")] | //android.widget.TextView[contains(@text, "Mohalla Name")]/parent::*//android.widget.EditText');
    await f.waitForDisplayed({ timeout: 10000 });
    await f.click();
    await f.clearValue();
    ...
    console.log('✅ Mohalla Name entered/edited successfully');
}
